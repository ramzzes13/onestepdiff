...
\begin{table}[t]
\caption{Comparison with published one-step methods on unconditional CIFAR-10 32$\times$32. $^\dagger$EDM teacher. $^\ddagger$DDPM teacher. $^\S$Single GPU, $<$1\,GB, 35K steps.}
...
\textbf{AdaDMD (ours)}$^\S$ & \textbf{1} & \textbf{28.06} & --- \\
\bottomrule
\end{tabular}
\end{table}
