...
\toprule
Phase 1 & Warmup & Aligned & 20K & 25K & 30K & Best \\
\midrule
3,000 & 3,000 & \checkmark & 191.0 & 123.0 & 144.4 & 106.4 (35K) \\
3,000 & 5,000 & & 145.7 & 138.4 & 86.4 & 86.4 (30K) \\
\textbf{5,000} & \textbf{5,000} & \checkmark & \textbf{114.7} & \textbf{50.1} & \textbf{28.1} & \textbf{28.1 (30K)} \\
7,000 & 5,000 & & 160.1 & 156.3 & 150.3 & 136.2 (35K) \\
7,000 & 7,000 & \checkmark & 132.1 & 137.7 & 144.1 & 132.1 (20K) \\
\bottomrule
\end{tabular}
\end{table}
...
Our best one-step result (28.06 FID at 30K steps with phase-aligned warmup) narrows the gap to CIFAR-10 state-of-the-art ($\sim$1--5 FID with multi-step sampling). Several factors limit further improvement: (1) the HuggingFace DDPM teacher itself produces imperfect 32$\times$32 images; (2) training uses 35K distillation steps versus 300K+ in DMD~\citep{yin2024onestep}; (3) the DDPM architecture at $t{=}0$ is not designed for direct noise-to-image mapping. However, the 87\% relative improvement from MSE (222 FID) to phase-aligned AdaDMD (28.06 FID) demonstrates the importance of learning rate schedule design for distribution matching distillation, and these relative gains should transfer to stronger base models.
